    ...
    <body>
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                ...
                <div class="btn-group btn-group-lg">
                    <a class="btn btn-info dropdown-toggle" data-toggle="dropdown">Usuário  </a>
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="../view/formUsuario.php">Cadastrar</a>
                        </li>
                        <li>
                            <a href="../controller/Listar_usuario.php">Listar</a>
                        </li>
                        <li>
                            <a href="../view/buscaUsuario.php">Buscar</a>
                        </li>
                        <li>
                            <a href="../view/buscaUsuario.php">Desativar</a>
                        </li>
                    </ul>
                </div>
